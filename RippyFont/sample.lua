...
frame.name = "RippyFont"
frame:Hide()

frame:SetScript("OnShow", function(self)
	local title, subtitle = LibStub("Rippy-Heading").new(self, "RippyFont", "This panel shows a preview for every major font template provided by Blizzard.")

	local group = LibStub("Rippy-Group").new(self)
...
LibStub("Rippy-AboutPanel").new("RippyFont", "RippyFont")
